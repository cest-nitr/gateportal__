        ...
        <div className='bg-[#205295] flex flex-col justify-center'>
          <form action="/" className='max-w-[400px] w-full mx-auto p-8 rounded-lg px-8 bg-white text-[#205295]'>
            ...
            <div className='flex justify-between py-2'>
              <p className='flex items-center'><input type="checkbox" className='mr-2 cursor-pointer'/>Remember me</p>
              <p className='cursor-pointer'>Forgot Password?</p>
            </div>
            <button className='w-full my-5 py-2 bg-[#205295] text-white font-semibold rounded-lg shadow-lg hover:shadow-sm'>Log in</button>
          </form>
        </div>
      </div>
    </>
